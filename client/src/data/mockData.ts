...
export const mockData : AnalyzerResponse = {
    score : 75,
    gaps : ['No direct experience in express transportation, logistics, or courier/shipment operations',
    ...
    suggestions : ['Reframe MetLife support desk experience to emphasize high-volume inbound inquiry handling, strict SLA adherence, and real-time case prioritization — closely mirroring FedEx call handling requirements',
